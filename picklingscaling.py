# -*- coding: utf-8 -*-
"""
Created on Sun Jun 25 09:56:07 2017
...
X = preprocessing.scale(X)  
                          #ojo: Aqui cambiamos el orden
X_lately = X[-forecast_out:]#esto es 10% del 90 %
X= X[:-forecast_out]#cortar el 10% del dataset 
...
#el pickle data se encuentra en el directorio desde el cual estamos trabajando
#porque ahi lo guardamos en el codigo del anterior comentario
